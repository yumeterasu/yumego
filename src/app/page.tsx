...
// Top page -- lives at the root URL. Always shows the class picker (never
// auto-redirects to /dashboard even if a class is already selected on this
// device), since this is meant to be the one fixed landing point.
